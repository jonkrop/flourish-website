...
subtitle: Tools for Thriving as a Midlevel Associate
intro: "The midlevel years are a genuine hinge point: more autonomy, less
  supervision, and the challenge of managing in two directions at once - the
...
sections:
  - title: Cheat Sheets
    collapsed: true
    items:
      - name: "TRIP: Making Asks That Build Goodwill"
        type: pdf
        url: /uploads/Flourish-TRIP.pdf
      - name: "The Two-Step: Dealing with Conflict"
        type: pdf
